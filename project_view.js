const projects = {
    "FitLife" : {
        ...
        imgUrls: [
            ...
            "assets/image/fitlife3.jpg", 
            "assets/image/fitlife4.jpg", 
            "assets/image/fitlife5.jpg"
        ]
    },
    "Artify" : {
        projectType:"Personal Project",
        ...
        imgUrls: [
            ...
            "assets/image/artify3.jpg", 
            "assets/image/artify4.jpg", 
            "assets/image/artify5.jpg"
        ]
    },
    "GreenPill" : {
        ...
        imgUrls: [
            ...
            "assets/image/greenpill3.jpg", 
            "assets/image/greenpill4.jpg", 
            "assets/image/greenpill5.jpg"
        ]
    },
    "To-Do" : {
        projectType:"Personal Project", 
    ...
    "KindBridge": {
        ...
        imgUrls: [
            ...
            "assets/image/kindbridge3.jpg", 
            "assets/image/kindbridge4.jpg", 
            "assets/image/kindbridge5.jpg"
        ]
    }
};
...
if(projects[projectName]){
    ...
    document.getElementById("projectLogo").src = projects[projectName].logo;
    document.getElementById("prImgOverlayText").textContent = "Project - " + projectName;
    ...
    document.getElementById("project-image-1").src = projects[projectName].imgUrls[0];
    document.getElementById("project-image-2").src = projects[projectName].imgUrls[1];
    document.getElementById("project-image-3").src = projects[projectName].imgUrls[2];
    document.getElementById("project-image-4").src = projects[projectName].imgUrls[3];
    document.getElementById("project-image-5").src = projects[projectName].imgUrls[4];
